...
export async function generateArticle(
  ...
  const systemInstruction = `
    ...
    КРИТИЧНИ ПРАВИЛА ЗА ФОРМАТИРАНЕ:
    1. ИЗПОЛЗВАЙ СТАНДАРТНИ БУКВИ (Sentence case). Пиши с малки и големи букви (нормален правопис).
    2. ЗАБРАНЕНО Е ПИСАНЕТО ТАКА: "ТОВА Е ЗАГЛАВИЕ". ВМЕСТО ТОВА ПИШИ ТАКА: "Това е заглавие".
    3. ЗАБРАНЕНО е писането само с ГЛАВНИ БУКВИ (ALL CAPS) в целия текст или в заглавията.
    4. ЗАБРАНЕНО е целият текст да бъде в ПОЛУЧЕР (BOLD). Използвай bold (**текст**) само за отделни важни думи, не за цели изречения.
    5. ПРЕРАЗКАЗВАЙ КОНТЕКСТА: Дори ако предоставените файлове или контекст са написани само с главни букви, ТИ ТРЯБВА да ги преработиш и напишеш с нормални малки и големи букви.
